...
**We should use unscaled data because the clusters are more distinct when using unscaled data.**
...
**The clustering results are not as good when using kmeans because some clusters, especially cluster 3, contain all of the cancer sub-types, which is not the optimal result for clustering analysis since we want the cluster to group distinct elements together.**
