...
**After cleaning the data, we have 1725 individuals in our sample. There are 729 female and 996 male (ratio of 0.42 : 0.58), and age ranges from 18 to 76. As seen from the histograms of age, education, and income: the distribution of age is right-skewed with a mean of 30.3 and a median of 28, 88.9% of the sample graduated from college with a Bachelor's, Associate's, or Graduate degree, and income distribution tells us that people who earn above $150,000 participated the least. The scatterplot of age, education, and whether if one listens to either channel shows that one's age and education level does not affect their response to listening to the channel or not.**
...
**The goal of the study is to estimate Wharton audience size by calculating the proportion of Wharton listeners to Sirius listeners, p, multiplied by 51.6 million, and it is estimated to be 2.58 million. The initial data size of 1764 people were collected through MTurk, but it was reduced down to 1725 after cleaning incomplete and incorrect data entries from surveys. Summary of the participants' demographic information shows that people who took the survey are indeed representative of the MTurk population, but they were not representative of the US population since people who take MTurk surveys are generally younger and more educated than the US population. Thus, we cannot extrapolate the results of the data to the general US population, but we can say that among the MTurk population, those who listen to Wharton radio is about 0.05% (p) of the population.**
