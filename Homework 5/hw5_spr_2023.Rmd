...
# number of trees
fit.rf <- randomForest(LogIncome~., IQ.train, mtry=10, ntree=500)    # change ntree
plot(fit.rf, col="red", pch=16, type="p", 
     main="default plot, ")

# mtry = 10 plot
fit.rf.final <- randomForest(LogIncome~., IQ.train, mtry=10, ntree=250)
plot(fit.rf.final)
fit.rf.final$mse[250]  # testing error of the RF based on 250 trees
```
